...
**v4.9** — analysis-integrity hardening promoted from real review cycles, plus journal-mechanics additions. Additive and backward-compatible; still 45 skills / 45 guidelines, analysis-integrity detectors **32 → 36**:
...
**v4.8** is the **review-harvest batch** — deterministic detector hardening promoted from real-manuscript review cycles. Additive and backward-compatible; still 45 skills / 45 guidelines, analysis-integrity detectors **30 → 32**:
...
**v4.7** is the **self-update foundation** — physician-researchers stay current without GitHub, git, or a terminal. Additive and backward-compatible; still 45 skills / 45 guidelines / 30 detectors:
...
**v4.6** is a maintainability, governance, and review-depth release — still 45 skills / 45 guidelines; analysis-integrity detectors **28 → 30**, domain probes 11 → 12:
...
**v4.5** deepens the review + submission surface with no new skill or reporting-guideline count (still 45 skills / 45 guidelines); analysis-integrity detectors **27 → 28**:
...
**v4.4** adds reviewer/analysis depth with no new skill or reporting-guideline count (still 45 skills / 45 guidelines / 27 detectors):
...
**v4.3** hardens the **cross-sectional / observational cohort** review surface end-to-end, much of it reverse-engineered from real CC-BY cohort papers (learn-only under the license firewall) — no new skill or reporting-guideline count (still 45 skills / 45 guidelines); analysis-integrity detectors **25 → 27**:
...
**v4.2** builds out the case-report capability end-to-end, grounded in real CC-BY case reports (learn-only under the license firewall) — no new skill or reporting-guideline count (still 45 skills / 45 guidelines); journal profiles **68 → 73**:
...
### 45 Reporting Guidelines & RoB Tools Built-in
`check-reporting` includes bundled checklists for 45 guidelines and risk-of-bias tools: STROBE, STROBE-MR, RECORD, STARD, STARD-AI, TRIPOD, TRIPOD+AI, TRIPOD-LLM, PGS-RS, CHEERS 2022, CROSS, SRQR, COREQ, PRISMA 2020, PRISMA-DTA, PRISMA-P, PRISMA-ScR, MOOSE, ARRIVE, CONSORT, CONSORT-AI, CARE, SPIRIT, SPIRIT-AI, CLAIM, DECIDE-AI, SQUIRE 2.0, CLEAR, GRRAS, MI-CLEAR-LLM, SWiM, AMSTAR 2, QUADAS-2, QUADAS-C, RoB 2, ROBINS-I, ROBINS-E, ROBIS, ROB-ME, PROBAST, PROBAST+AI, NOS, COSMIN, RoB NMA. Includes Results/Discussion section boundary checks and machine-readable JSON summary for pipeline integration.
