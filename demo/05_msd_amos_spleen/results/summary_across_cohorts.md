...
### rung3b AMOS MRI rescaled (counterfactual)
- **Spleen volume (gt_ml)**
    - small (<100 mL): n=7, Dice 0.0000 [0.0000-0.3801]
    - normal (100-250 mL): n=41, Dice 0.3086 [0.1744-0.5011]
    - enlarged (>=250 mL): n=11, Dice 0.3321 [0.0514-0.6257]
- **Slice thickness (spacing_z)**
