...
| arm | n scored | Dice median [95% CI] | HD95 mm median [95% CI] | dDice vs internal |
|---|---:|---|---|---|
| rung1 MSD held-out (internal) | 9 | 0.9595 [0.9367-0.9734] | 1.7846 [1.5898-2.5000] |  |
| rung2 AMOS CT (external) | 298 | 0.8932 [0.8639-0.9108] | 5.6784 [4.8452-8.4039] | -0.0662 |
| rung3 AMOS MRI (modality shift) | 59 | 0.0152 [0.0000-0.0626] | 70.0457 [45.6939-131.0409] | -0.9443 |
...
- **Spleen volume (gt_ml)**
    ...
    - normal (100-250 mL): n=194, Dice 0.9114 [0.8940-0.9259]
    - enlarged (>250 mL): n=67, Dice 0.7694 [0.6134-0.8681]
- **Slice thickness (spacing_z)**
    - thin (<=2 mm): n=5, Dice 0.9219 [0.8584-0.9368]
    - mid (2-5 mm): n=74, Dice 0.9292 [0.8907-0.9415]
...
- **Slice thickness (spacing_z)**
    - thin (<=2 mm): n=26, Dice 0.0057 [0.0000-0.1120]
    - mid (2-5 mm): n=33, Dice 0.0343 [0.0000-0.2402]
