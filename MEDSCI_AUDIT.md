...
The 89 detectors fall into six audit families:
...
| Citation & reference integrity | 10 | `verify_refs`, `check_citation_keys`, `check_citekey_provenance`, `check_xref`, `check_csl_render`, `check_reference_adequacy`, `check_placeholders`, `check_reference_duplication`, `check_bib_title_markup`, `check_claim_fidelity` |
...
- **Current detector catalog: 89** (the enumerated list in `metadata/detectors_catalog.json`).
