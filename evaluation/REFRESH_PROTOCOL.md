...
- **Current catalog: 83 detectors** across six families (as of 2026-07-24; the authoritative
...
- **2026-07-24 — catalog 82 → 83** (`check_credit_integrity`, reporting compliance). No run exists; nothing invalidated.
